...
pubDate: 2018-02-11
heroImage: '../../../assets/blog-placeholder-painted-hills.jpg'
---

import { Image } from 'astro:assets';
import vsCodeScreenhot from './vs-code-screenshot.png';
import vsCodeExtensions from './vs-code-extensions.png';
import gitkrakenScreenshot from './gitkrakenscreenshot.png';
import chromeDeveloperToolsScreenshot from './chromedevelopertoolsscreenshot.png';
import auguryScreenshot from './augury-screen-shot.png';
...
![power-tools-500x500](./power-tools-500x500.jpg)
...
![pexels-photo-270366.jpeg](./pexels-photo-270366.jpeg)
...
<figure>
  <Image
    src={vsCodeScreenhot}
    alt="VS Code allows for a rather clean environment for hacking away on all sorts of projects."
  />
  <figcaption>
    VS Code allows for a rather clean environment for hacking away on all sorts
    of projects.
  </figcaption>
</figure>
...
- [Angular v5 Snippets](https://github.com/johnpapa/vscode-angular-snippets) from [@John_Papa](https://twitter.com/John_Papa) - Adds snippets for Angular 2+ for TypeScript and HTML. This extension really helps when implementing new services or directives. Thanks John!
...
<figure>
  <Image
    ...
    alt="Extensions extend the possibilities!"
  />
  <figcaption>
    Extensions extend the possibilities!
  </figcaption>
</figure>
...
<figure>
  <Image
    src={chromeDeveloperToolsScreenshot}
    alt="The Chrome dev tools are like your own digital tool shed!"
  />
  <figcaption>
    The Chrome dev tools are like your own digital tool shed!
  </figcaption>
</figure>
...
<figure>
  <Image
    src={auguryScreenshot}
    alt="Augury shows you what's what in the component tree."
  />
  <figcaption>
    Augury shows you what's what in the component tree.
  </figcaption>
</figure>
