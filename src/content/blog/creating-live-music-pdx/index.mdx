...
pubDate: 2018-09-02
heroImage: '../../../assets/blog-placeholder-mt-hood.jpg'
---
import { Image } from 'astro:assets';
import trelloLiveMusicPDX2 from './trello-live-music-pdx2.png';
import evernoteLiveMusicPDX1 from './evernote-live-music-pdx1.png';
import angular6SnippetsExtension from './angular-6-snippets-extension.png';
import angularMaterial from './angular-material.png'
...
![man wearing black and white stripe shirt looking at white printer papers on the wall](./pexels-photo-212286.jpeg)
...
<figure>
  <Image
    src={trelloLiveMusicPDX2}
    alt="Trello makes managing your to-dos a breeze"
  />
  <figcaption>
    Trello makes managing your to-dos a breeze
  </figcaption>
</figure>
...
<figure>
  <Image
    src={evernoteLiveMusicPDX1}
    alt="(Evernote) Gotta keep the users in mind!"
  />
  <figcaption>
    (Evernote) Gotta keep the users in mind!
  </figcaption>
</figure>
...
<figure>
  <Image
    src={angular6SnippetsExtension}
    alt="Extremely handy extension for Angular development - Look it up under 'extensions' in VS Code"
  />
  <figcaption>
    Extremely handy extension for Angular development - Look it up under 'extensions' in VS Code
  </figcaption>
</figure>

#### Angular 6 and the Angular CLI

I coded this application using the latest version of [Angular 6](https://angular.io/) and the [Angular CLI](https://cli.angular.io/) (v6.1.6 and v6.15 respectively, at the time of this writing).  Angular and it's CLI (command line interface) is my front-end framework of choice. It's loaded with awesome tooling and provides a fully fleshed out feature set and ecosystem that I've come to really enjoy working with.  ![angular](./angular.png)The Angular CLI is incredibly powerful and really easy to spin up a new project quickly.  Also, with nice improvements and features added with every major release, Angular is only getting better from here.
...
<figure>
  <Image
    src={angularMaterial}
    alt="Angular Material has your styled components covered"
  />
  <figcaption>
    Angular Material has your styled components covered
  </figcaption>
</figure>
