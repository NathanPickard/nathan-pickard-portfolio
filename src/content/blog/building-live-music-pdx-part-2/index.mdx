...
pubDate: 2018-12-19
heroImage: '../../../assets/blog-placeholder-oregon-coast.jpg'
---
import { Image } from 'astro:assets';
import liveMusicPDXVSCode from './live-music-pdx-vs-code.png'
...
![under construction signage on laptop keyboard](./pexels-photo-211122.jpeg)
...
<figure>
  <Image
    src={liveMusicPDXVSCode}
    alt="Every module has a home"
  />
  <figcaption>
    Every module has a home
  </figcaption>
</figure>
...
![newly make high rise building](./architecture-construction-build-building-162557.jpeg)
...
![bridge clouds cloudy dark clouds](./pexels-photo-556416.jpeg)
...
![IMG_20181022_192804-COLLAGE](./img_20181022_192804-collage.jpg)
