...
tags: 
  ...
  - "typescript"
  - "web-development"
heroImage: '../../../assets/blog-placeholder-columbia-gorge.jpg'
---
import { Image } from 'astro:assets';
import openedInVSCode from './opened-in-vs-code.png';
import chuckNorrisFact from './chuck-norris-fact.png';

![angular-console-social-card](./angular-console-social-card.png)
...
![black and white business close up computer](./pexels-photo-84763.jpeg)
...
![chuck norris kick](./chuck-norris-kick.png)
...
Go ahead and give a location where you'd like the project to live on your computer.  In ![parent directory](./parent-directory.png)my case, I'm putting this project on my desktop in a folder titled "Awesome Chuck Norris app".

In the next field, type in the name of the workspace or "project name".  Let's title it "chuck-norris-facts".

![workspace name](./workspace-name.png)
...
![schematic set](./schematic-set.png)It's the equivalent of executing the "ng new 'whatever-app-name-here'" terminal command using the Angular CLI.
...
![creating workspace](./creating-workspace.png)
...
<figure>
  <Image
    src={openedInVSCode}
    alt=" Voilá!  Here we have our freshly created app opened in VS Code!"
  />
  <figcaption>
...
![component fields](./component-fields.png)
...
![component complete](./component-complete.png)
...
![generated component vscode](./generated-component-vscode.png)
...
```ts title='chuck-norris-facts.component.ts'
...
Next, let's create that "FactsService" mentioned above to carry out the call to the Chuck Norris API.![generate service](./generate-service.png)
...
![chuck norris wearing hat](./chuck-norris-wearing-hat.png)
...
![component html](./component-html-2.png)
...
![run-serve](./run-serve-1.png)![configuration-serve](./configuration-serve.png)
...
![open app](./open-app.png)As we can see,  we have our web application deployed in the browser and ready for the end user.  Sweet!![launched app](./launched-app.png)
...
![chuck norris in suit](./chuck-norris-in-suit-1.png)
