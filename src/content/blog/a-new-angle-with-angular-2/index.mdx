...
description: "Notes on migrating from AngularJS to Angular 2+"
pubDate: 2017-11-12
tags: 
  - "angular"
  - "angularjs"
  - "web-development"
heroImage: '../../../assets/blog-placeholder-smith-rock.jpg'
---
import { Image } from 'astro:assets';
import angularjsLogo from './angularjs-shield-medium.png';
import angularLogo from './angular.png';

<div class="post-float-right">
  <Image src={angularjsLogo} alt="AngularJS" />
...
In the following block of code from a product management application, in comparison to the recipe controller above, we can see Angular's architecture in action. 
